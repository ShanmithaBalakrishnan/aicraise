    ...
    function c(t, e) {
      for (var n = {}, r = [], o = 0; o < t.length; o++) {
        ...
        -1 !== u
          ...
          : s.push({ identifier: l, updater: v(d, e), references: 1 }),
          r.push(l);
      }
      return r;
    }
    ...
    t.exports = function (t, e) {
      ...
      return function (t) {
        if (
          ...
          for (var a = c(t, e), p = 0; p < n.length; p++) {
            var l = i(n[p]);
          ...
          return this.map(function (e) {
            var n = (function (t, e) {
              ...
              if (e && "function" == typeof btoa) {
                var o =
                    ((s = r),
                    (i = btoa(unescape(encodeURIComponent(JSON.stringify(s))))),
                    (c =
  ...
  function (t, e, n) {
        ...
        (n = [
          {
            ...
            value: function (t, e) {
              t = t || "name";
              for (
                var n = document.getElementsByTagName("meta"), r = 0;
                r < n.length;
                r++
              )
                if (n[r].getAttribute(t) === e)
                  return n[r]
          ...
          {
            key: "getAllElementsWithAttribute",
            value: function (t, e) {
              for (
                var n = [],
                  r = (e = e || document).getElementsByTagName("*"),
                  o = 0,
                  a = r.length;
                o < a;
                o++
              )
                null !== r[o].getAttribute(t) && n.push(r[o]);
              return n;
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t, e, n) {
              var r = [];
              e instanceof Array ? (r = e) : r.push(e);
              for (
                var o = function (e) {
                    r[e].attachEvent
                      ? r[e].attachEvent("on" + t, function () {
                          n.call(r[e]);
                        })
                      : r[e].addEventListener &&
                        r[e].addEventListener(t, n, !1);
                  },
                  a = 0;
                a < r.length;
                a++
          ...
          {
            key: "addJavascriptFile",
            value: function (t, e) {
              if (!this.elementById(e)) {
          ...
          },
          {
            key: "openWindow",
            value: function (t, e, n) {
              var r = e ? "opensocialsharingpopupchildwindow" : "",
                o = window.open(
                  t,
                  r,
          ...
          },
          {
            ...
            value: function () {
              return document.getElementById("s9-sdk").getAttribute("content");
            },
          },
        ]) && r(e.prototype, n),
        o && r(e, o),
    ...
    var s = (function () {
      ...
      return (
        ...
        (n = [
          ...
          {
            key: "convertNumberToCounterValue",
            value: function (t) {
              return Math.abs(t) < 1e3
                ? Math.sign(t) * Math.abs(t)
                : Math.abs(t) >= 1e3 && Math.abs(t) < 1e6
                ? Math.sign(t) * (Math.abs(t) / 1e3).toFixed(1) + "K"
                : Math.sign(t) * (Math.abs(t) / 1e6).toFixed(1) + "M";
            },
          },
          {
      ...
      f = (function () {
        function t() {
          ...
          l(this, t),
            (this.props = c({}, e)),
            (this.sdkURL =
              "https://connect.facebook.net/en_US/all.js#xfbml=1&appId=1441207319494394&version=v3.0"),
          ...
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) {
                  if ("inline" === r) {
                    d.addJavascriptFile(this.sdkURL, this.sdkID);
                    var i = {
                      class: "fb-share-button ",
                      href: t.share_url || location.href,
                      layout: "button",
                      size: "small",
                    };
                    return '<div class="'
                      .concat(i.class, '" data-href="')
                      .concat(i.href, '" data-layout="')
                      .concat(i.layout, '" data-size="')
                      .concat(i.size, '"></div>');
                  }
                  return "";
                }
                var c = this.provider.toLowerCase(),
                  p = h.convertNumberToCounterValue(a),
                  l =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      p,
                      "</span>\n\t\t\t\t</div>"
                    ),
                  u =
                    '<svg\n              xmlns="http://www.w3.org/2000/svg"\n              xmlns:xlink="http://www.w3.org/1999/xlink"\n              viewBox="0 0 32 32"\n              version="1.1"\n              role="img"\n              aria-labelledby="s9-svg-'
                      .concat(c, "-")
                      .concat(s, '"\n              class="s9-icon s9-icon-')
                      .concat(
                        c,
                        '"\n            >\n              <title id="s9-svg-'
                      )
                ...
                switch (r) {
                  case "inline":
                    return "<a \n\t\t\t\t\ttitle="
                      ...
                      .concat(this.provider, " data-href=")
                      .concat(
                        e,
                        ' role="button" tabindex="0" class="s9-btn-share s9-'
                      )
                      .concat(c, " ")
                      .concat(
                        o ? "s9-share-counter" : "",
    ...
    var m = new o(),
      ...
      x = (function () {
        function t() {
          ...
          w(this, t),
            (this.props = v({}, e)),
            (this.sdkURL = "https://platform.twitter.com/widgets.js"),
            (this.sdkID = "twitter-wjs"),
          ...
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) {
                  if ("inline" === r) {
                    m.addJavascriptFile(this.sdkURL, this.sdkID);
                    var i = {
                    ...
                    return '<a class="'
                      .concat(i.class, '" data-size="')
                      .concat(i.size, '" data-url="')
                      .concat(
                        i.href,
                        '" data-hashtags="" data-text="" data-via="" href="https://twitter.com/intent/tweet">\n\t\t\t\tTweet</a>'
                      );
                  }
                  return "";
                }
                var c = this.provider.toLowerCase(),
                  p = O.convertNumberToCounterValue(a),
                  l =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      p,
                      "</span>\n\t\t\t\t</div>"
    ...
    var C = new o(),
      ...
      S = (function () {
        function t() {
          ...
          P(this, t),
            (this.props = j({}, e)),
            (this.sdkURL = "https://platform.linkedin.com/in.js"),
            (this.sdkID = "linkedin-wjs"),
            ...
            },
            {
              ...
              value: function () {
                var t =
                    arguments.length > 0 && void 0 !== arguments[0]
                      ? arguments[0]
                      : { share_url: "", default_buttons: !0, widget_type: "" },
                  e = t.share_url,
                  n = t.default_buttons,
                  r = t.widget_type,
                  o = t.show_counter,
                ...
                if (n) {
                  if ("inline" === r) {
                    C.addJavascriptFile(this.sdkURL, this.sdkID);
                    var i = {
                      class: "",
                      href: t.share_url || location.href,
                      layout: "top",
                    };
                    return '<script type="IN/Share" data-counter="'
                      .concat(i.layout, '" data-url="')
                      .concat(i.href, '"></script>');
                  }
                  return "";
                }
                var c = this.provider.toLowerCase(),
                  p = z.convertNumberToCounterValue(a),
                  l =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      p,
                      "</span>\n\t\t\t\t</div>"
                ...
                switch (r) {
                  case "inline":
                    return "<a \n\t\t\t\t\ttitle="
                      ...
                      .concat(o ? l : "", "\n        </a>");
                  case "floating":
                    var d = this.provider.toLowerCase();
                    return "<a  data-provider="
                      .concat(this.provider, " data-href=")
                      .concat(
                        e,
    ...
    var B = new s(),
      ...
      V = (function () {
        function t() {
          ...
          L(this, t),
            (this.props = M({}, e)),
            (this.sdkURL = "https://assets.pinterest.com/js/pinit.js"),
            (this.sdkID = "pinterest-wjs"),
            (this.provider = "Pinterest");
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) {
                  if ("inline" === r) {
                    I.addJavascriptFile(this.sdkURL, this.sdkID);
                    var i = {
                      class: t.class,
                      href: t.share_url || location.href,
                      layout: "",
                    };
                    return '<div id="pinterestId"> <a data-pin-config="'
                      .concat(
                        i.layout,
                      ...
                      .concat(
                        i.url,
                        '"  data-pin-do="buttonPin"   data-pin-color="white"  ><img src="https://assets.pinterest.com/images/pidgets/pin_it_button.png" /></a> </div>'
                      );
                  }
                  return "";
                }
                var c = this.provider.toLowerCase(),
                  p = B.convertNumberToCounterValue(a),
                  l =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      p,
                      "</span>\n\t\t\t\t</div>"
    ...
    var W = (function () {
      function t() {
        var e =
          arguments.length > 0 && void 0 !== arguments[0]
            ? arguments[0]
            : { widget_type: "inline", unique_id: "1", default_buttons: !1 };
        U(this, t), (this.props = N({}, e)), (this.provider = "Social9");
      }
      var e, n, r;
      return (
        (e = t),
        (n = [
          {
            ...
            value: function () {
              ...
              if (this.props.default_buttons)
                return "inline" === e
                  ? '<a style="max-height: 12px; border-radius: 3px; padding: 4px 1px" data-provider='
                      .concat(
                        this.provider,
                        ' role="button" tabindex="0" class="s9-btn-share s9-'
                      )
    ...
    var $ = new s(),
      K = (function () {
        function t() {
          ...
          Y(this, t), (this.props = G({}, e)), (this.provider = "Print");
        }
        var e, n, r;
        return (
          (e = t),
            ...
            },
            {
              ...
              value: function () {
                var t =
                  ...
                  s = t.unique_id;
                if (r) return "";
                var i = this.provider.toLowerCase(),
                  c = $.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
    ...
    var rt = new s(),
      ot = (function () {
        function t() {
          ...
          et(this, t), (this.props = Z({}, e)), (this.provider = "Email");
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (r) return "";
                var i = this.provider.toLowerCase(),
                  c = rt.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
                ...
                switch (n) {
                  case "inline":
                    return "<a \n\t\t\t\t\ttitle="
                      ...
                      .concat(o ? p : "", "\n        </a>");
                  case "floating":
                    var u = this.provider.toLowerCase();
                    return "<a  data-provider="
                      .concat(this.provider, " data-href=")
                      .concat(
                        e,
    ...
    var lt = new s(),
      ut = (function () {
        function t() {
          ...
          ct(this, t), (this.props = st({}, e)), (this.provider = "Blogger");
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) return "";
                var i = this.provider.toLowerCase(),
                  c = lt.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
    ...
    var gt = new s(),
      wt = (function () {
        function t() {
          ...
          bt(this, t), (this.props = ht({}, e)), (this.provider = "Tumblr");
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) return "";
                var i = this.provider.toLowerCase(),
                  c = gt.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
    ...
    var jt = new s(),
      kt = (function () {
        function t() {
          ...
          xt(this, t), (this.props = mt({}, e)), (this.provider = "Reddit");
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) return "";
                var i = this.provider.toLowerCase(),
                  c = jt.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
    ...
    var Dt = new s(),
      Mt = (function () {
        function t() {
          ...
          zt(this, t), (this.props = Et({}, e)), (this.provider = "Slack");
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) return "";
                var i = this.provider.toLowerCase(),
                  c = Dt.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
    ...
    var Vt = new s(),
      At = (function () {
        function t() {
          ...
          Bt(this, t), (this.props = Lt({}, e)), (this.provider = "Whatsapp");
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) return "";
                var i = this.provider.toLowerCase(),
                  c = Vt.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
    ...
    var Ft = new s(),
      Gt = (function () {
        function t() {
          ...
          Rt(this, t), (this.props = Ht({}, e)), (this.provider = "Gmail");
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) return "";
                var i = this.provider.toLowerCase(),
                  c = Ft.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
    ...
    var Qt = new s(),
      Zt = (function () {
        function t() {
          ...
          $t(this, t), (this.props = Yt({}, e)), (this.provider = "Evernote");
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) return "";
                var i = this.provider.toLowerCase(),
                  c = Qt.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
    ...
    var ae = new s(),
      se = (function () {
        function t() {
          ...
          re(this, t), (this.props = ee({}, e)), (this.provider = "Wechat");
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) return "";
                var i = this.provider.toLowerCase(),
                  c = ae.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
    ...
    var de = new s(),
      he = (function () {
        function t() {
          ...
          le(this, t), (this.props = ce({}, e)), (this.provider = "Skype");
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) return "";
                var i = this.provider.toLowerCase(),
                  c = de.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
    ...
    var ye = new s(),
      me = (function () {
        function t() {
          ...
          ge(this, t), (this.props = be({}, e)), (this.provider = "YahooMail");
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) return "";
                var i = this.provider.toLowerCase(),
                  c = ye.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
    ...
    var Pe = new s(),
      Ee = (function () {
        function t() {
          ...
          je(this, t), (this.props = xe({}, e)), (this.provider = "Digg");
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) return "";
                var i = this.provider.toLowerCase(),
                  c = Pe.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
    ...
    var Te = new s(),
      Le = (function () {
        function t() {
          ...
          De(this, t), (this.props = ze({}, e)), (this.provider = "Buffer");
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) return "";
                var i = this.provider.toLowerCase(),
                  c = Te.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
    ...
    var Ne = new s(),
      He = (function () {
        function t() {
          ...
          Ve(this, t), (this.props = Be({}, e)), (this.provider = "MySpace");
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) return "";
                var i = this.provider.toLowerCase(),
                  c = Ne.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
    ...
    var Je = new s(),
      Ye = (function () {
        function t() {
          ...
          Fe(this, t), (this.props = Re({}, e)), (this.provider = "Vkontakte");
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (r) return "";
                var i = this.provider.toLowerCase(),
                  c = Je.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
    ...
    var tn = new s(),
      en = (function () {
        function t() {
          ...
          Qe(this, t), (this.props = $e({}, e)), (this.provider = "Line");
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) return "";
                var i = this.provider.toLowerCase(),
                  c = tn.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
    ...
    var cn = new s(),
      pn = (function () {
        function t() {
          ...
          an(this, t), (this.props = rn({}, e)), (this.provider = "Telegram");
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) return "";
                var i = this.provider.toLowerCase(),
                  c = cn.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
          ...
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) return "";
                var i = this.provider.toLowerCase(),
                  c = bn.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
                ...
                switch (r) {
                  case "inline":
                    return "<a \n\t\t\t\t\ttitle="
                      ...
                      .concat(this.provider.substr(6), "</span>\n\t\t\t\t\t")
                      .concat(o ? p : "", "\n        </a>");
                  case "floating":
                    return "<a  data-provider="
                      .concat(this.provider, " data-href=")
    ...
    var xn = new s(),
      _n = (function () {
        function t() {
          ...
          mn(this, t), (this.props = wn({}, e)), (this.provider = "Pocket");
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) return "";
                var i = this.provider.toLowerCase(),
                  c = xn.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
    ...
    var zn = new s(),
      Sn = (function () {
        function t() {
          ...
          En(this, t), (this.props = kn({}, e)), (this.provider = "Flipboard");
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (n) return "";
                var i = this.provider.toLowerCase(),
                  c = zn.convertNumberToCounterValue(a),
                  p =
                    '<div class="s9-share-count-container">\n\t\t\t\t\t<span class="s9-share-count">'.concat(
                      c,
                      "</span>\n\t\t\t\t</div>"
    ...
    var Nn,
      ...
      Un = function (t) {
        ...
        return fetch(u, {
          method: o,
          headers: Vn(Vn({}, l), {}, { "Content-Type": "application/json" }),
          body: Hn.isEmpty(c) ? null : JSON.stringify(c),
        }).then(function (t) {
          return t
            .json()
            .catch(function (t) {
              return t instanceof SyntaxError ? Promise.resolve({}) : t;
            })
            .catch(console.error);
        });
      },
      Rn = "https://shr.social9.com/api/v1",
      Wn = "https://api.social9.com/api/v1",
      Fn = "https://api.social9.com/insights/track",
      Gn = { small: "32px", medium: "40px", large: "48px" },
      Jn = { small: "20px", medium: "32px", large: "48px" };
    var Yn = function () {
      return (
        Nn ||
        (Nn = Un({ url: "".concat(Wn, "/widgets/config"), method: "GET" }))
      );
    };
    function Xn(t, e) {
      for (var n = 0; n < e.length; n++) {
    ...
    var $n = (function () {
      ...
      return (
        ...
        (n = [
          ...
          {
            key: "shouldShowIndividualShareCounter",
            value: function () {
              var t =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ? arguments[0]
                ...
                r = t.min_show_count;
              return (
                ("individual" === n || "individual & total" === n) &&
                (null === r || e >= r)
              );
            },
          },
          {
            key: "shouldShowTotalShareCounter",
            value: function () {
              var t =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ? arguments[0]
        ...
        (n = [
          {
            ...
            value: function () {
              var t = this.props,
                ...
                n = t.widget_type,
                r = t.show_counter,
                o = e.querySelector(".s9-icon-wrap"),
                a = e.querySelector("svg"),
                s = e.querySelector(".s9-label"),
                i = { small: "24px", medium: "28px", large: "32px" },
                c = this.props.buttons,
                p = c.size,
                l = c.color,
                u = c.bg_color,
                d = c.icon_color,
                h = c.border_radius,
                f = c.hide_label,
                b = e.getAttribute("data-provider").toLowerCase();
              "floating" === n
                ? ((e.style.height = r
                    ? "social9" === b
                      ? Gn[p]
                      : "".concat(+Gn[p].substr(0, 2) + 20, "px")
                    : Gn[p]),
                  (e.style.width = Gn[p]),
                  (o.style.height = Gn[p]),
                  (o.style.width = Gn[p]),
                ...
                : "inline" === n &&
                  ...
                  null !== l && (s.style.color = l)),
                null !== u && (e.style.backgroundColor = u),
                null !== d && (a.style.fill = d),
                null !== h && (e.style.borderRadius = "".concat(h, "px")),
                "inline" === n && f && (s.style.display = "none");
            },
          },
        ]) && er(e.prototype, n),
        r && er(e, r),
          ...
          (n = [
            {
              ...
              value: function () {
                var t = {
                    ...
                    left: "s9-left",
                    right: "s9-right",
                    "top-left": "s9-top-left",
                    "top-right": "s9-top-right",
                    "bottom-left": "s9-bottom-left",
                    "bottom-right": "s9-bottom-right",
                  },
                  e = {
                    left: "popup-with-left-image",
                    right: "popup-with-right-image",
                    top: "popup-with-top-image",
                    bottom: "popup-with-bottom-image",
                    background: "popup-with-background-image",
                    "no-image": "popup-no-image",
                  },
                  n = this.props,
                  r = n.widget_type,
                  o = n.element,
                  a = (n.widget_category, n.design.popup),
                  s = n.resources,
                  i = this.props.layout,
                  c = i.position,
                  p = (i.responsive_width, this.props.design.animations),
                  l = p.hover,
                  u = (p.entrance, cr.isMobile());
                switch (
                  (((c.desktop.hide && !u) || (c.mobile.hide && u)) &&
                    o.classList.add("s9-popup-hidden"),
                  c.desktop.offset && !u
                    ? (o.style.top = "".concat(c.desktop.offset, "%"))
                    : c.mobile.offset &&
                      u &&
                      (o.style.top = "".concat(c.mobile.offset, "%")),
                  r)
                ) {
                  case "floating":
                    "right" !== c.desktop.value ||
                      u ||
                      (o.classList.remove("s9-position-left"),
                      o.classList.add("s9-position-right")),
                      "bottom" === c.mobile.value &&
                        u &&
                        (o.classList.add("mob-bottom"),
                        o.classList.remove("s9-position-left")),
                      "top" === c.mobile.value &&
                        u &&
                        (o.classList.remove("mob-bottom"),
                        o.classList.add("mob-top"),
                        o.classList.remove("s9-position-left"));
                    break;
                  case "inline":
                    break;
                  case "popup":
                    ...
                    if (
                      (u
                        ? o.classList.add(t[h.value])
                        : o.classList.add(t[d.value]),
                      o.classList.add(
                        {
                          large: "s9-poup-large",
                          medium: "s9-popup-medium",
                          small: "s9-popup-small",
                          "x-small": "s9-popup-x-small",
                        }[a.size]
                      ),
                      s && !s.src)
                    )
                      o.classList.add(e["no-image"]);
                    else {
                      var f = s.style.position;
                      ["medium", "large"].includes(a.size) &&
                        o.classList.add(e[f]);
                    }
                }
                "none" !== l && o.classList.add(l);
              },
            },
          ]) && ir(e.prototype, n),
          r && ir(e, r),
          ...
          (n = [
            {
              ...
              value: function () {
                var t = this.props,
                  e = t.widget_type,
                  n = t.share_count,
                  r = (t.show_counter, t.widget_id),
                  o = vr.convertNumberToCounterValue(n);
                switch (e) {
                  case "floating":
                    return '\n          <div class="s9-total-counter">\n            <div id="s9-total-share-count-'
                      .concat(
                        r,
            ...
            arguments.length > 0 && void 0 !== arguments[0]
              ...
              : {
                  ...
                  options: {
                    container: "",
                    show_url: [],
                    counter: { type: "none", min_show_count: 0 },
                  },
                  providers: { list: [], use_default_buttons: !0 },
                  rules: {},
                  shares: { total: 0, twitter: 0 },
                  design: { butons: {}, popup: { size: "" } },
                  layout: { position: {}, mobile: {}, responsive_width: {} },
                  pages: [],
                };
          _r(this, t),
            (this.config = Or({}, e)),
            (this.widget_type = this.config.widget_type),
            (this.default_buttons = this.config.providers.use_default_buttons),
            (this.customShareUrlExists =
              !!this.config.providers.list[0].share_url);
        }
        var e, n, r;
        return (
          (e = t),
          (n = [
            {
              ...
              value: function () {
                var t = this,
                  ...
                  r = e.id,
                  o = e.widget_category,
                  a = this.config.providers.list,
                  s = this.config.options.counter,
                  i = !1,
                  c = [];
                if ("inline" === n) {
                  var p = this.config.options.container;
                  if (
                    ((p =
                    ...
                    return void console.warn("Container not found!!!");
                  (c = p.startsWith("#")
                    ? [document.querySelector(p)]
                    : wr(document.querySelectorAll(p))).forEach(function (t) {
                    var e = kr.createElement("div");
                    (e.id = "s9-share-inline"),
                      (e.classList = "s9-share-inline s9-inline"),
                      t.appendChild(e);
                  }),
                    this.createSubsetWidget({
                      providersList: a,
                      parent: c,
                      widget_type: n,
                      widget_id: r,
                    ...
                    this.checkIfSocial9ProviderExists(a) &&
                      this.createPopupWidget();
                } else if ("floating" === n)
                  ((c = [kr.createElement("div")])[0].id = "s9-share-floating"),
                    (c[0].classList =
                      "s9-floating s9-position-top s9-position-left"),
                  ...
                  var l = this.config.rules.show_on,
                    u = this.config.pages[0],
                    d = u.header,
                    h = u.sub_header,
                    f = u.resources,
                    b = u.fields,
                    v = u.buttons,
                    g = u.background_image,
                    w = this.config.design.popup.size,
                    y = kr.createElement("div");
                  (y.id = "s9-popup-".concat(r)),
                    (y.className = "s9-popup-wrapper text-center ".concat(
                      g ? "popup-with-background-image" : ""
                    )),
                    this.getPopupCookie("popupclosed") &&
                      y.classList.add("s9-popup-hidden"),
                    "load" != l && (y.style.display = "none");
                  var m = kr.createElement("div");
                  switch (
                    ((m.className = "s9-popup-overlay"),
                    y.appendChild(m),
                    ...
                    case void 0:
                      ...
                      (_.className = "s9-popup-modal"),
                          ...
                          '\n\t\t\t\t\t<div class="s9-popup-modal-inner">\n\t\t\t\t\t\t<div class="s9-popup-close">\n\t\t\t\t\t\t\t<a id="popup-close-'
                            ...
                            .concat(
                              g
                                ...
                                : null,
                              '>\n\t\t\t\t\t\t\t<div>\n\t\t\t\t\t\t\t\t<div class="s9-popup-header">\n\t\t\t\t\t\t\t\t\t<div class="s9-popup-heading">'
                            )
                            .concat(
                              d,
                              '</div>\n              \t\t<div class="s9-popup-subheading">'
                            )
                            .concat(
                              h,
                        ...
                        y.appendChild(_);
                      var j = document.getElementById("s9-popup-share-inline"),
                        k = kr.createElement("div");
                      (k.id = "s9-share-inline"),
                        (k.classList = "s9-share-inline s9-inline"),
                        j.appendChild(k),
                        this.createSubsetWidget({
                          providersList: a,
                          parent: [k],
                    ...
                    case "email_subscription":
                      var P = f[0],
                        E = (P.type, P.src),
                        C = v[0].display_text,
                        z = kr.createElement("div");
                      (z.className = "s9-popup-modal"),
                        (z.innerHTML +=
                          '\n\t\t\t\t\t<div class="s9-popup-modal-inner">\n\t\t\t\t\t\t<div class="s9-popup-close">\n\t\t\t\t\t\t\t<a id="popup-close-'
                            .concat(
                              r,
                        ...
                        y.appendChild(z);
                      var S = document.getElementById("s9-popup-form");
                      b.forEach(function (t) {
                        var e = t.type,
                          n = kr.createElement("div");
                        n.className = "s9-popup-fieldgroup";
                        var r = kr.createElement("input");
                        (r.type = e),
                          (r.value = ""),
                          (r.name = e),
                          (r.placeholder = "Enter your email"),
                          n.appendChild(r),
                          S.appendChild(n);
                      });
                      var D = kr.createElement("button");
                      (D.type = "submit"),
                        (D.innerHTML = C),
                        S.appendChild(D),
                        D.addEventListener("click", function (e) {
                          ...
                          var n = S.email.value;
                          Un({
                            url: "".concat(Wn, "/subscribe/"),
                            method: "",
                            queryParams: {
                              user_id: kr.getUserIdentifier(),
                              widget_id: r,
                              email: n,
                              site: location.href,
                            },
                            ...
                            document.getElementById("popup-close"),
                              ...
                              t.setPopupCookie("popupclosed", !0, 1);
                          });
                        }),
                        new pr({
                          layout: this.config.layout,
                    ...
                    case "introduction":
                      var M = f[0],
                        T = (M.type, M.src),
                        L = kr.createElement("div");
                      (L.className = "s9-popup-modal"),
                        (L.innerHTML +=
                          '\n\t\t\t\t\t<div class="s9-popup-modal-inner">\n\t\t\t\t\t\t<div class="s9-popup-close">\n\t\t\t\t\t\t\t<a id="popup-close-'
                            .concat(
                              r,
                  ...
                  document
                    .getElementById("popup-close-".concat(r))
                    .addEventListener("click", function () {
                      (y.style.display = "none"),
                        t.setPopupCookie("popupclosed", !0, 1);
                    }),
                    window.addEventListener(l, function () {
                      i || ((i = !0), (y.style.display = "block"));
                    });
                }
                return c;
              },
            },
            {
              ...
              value: function () {
                var t = this,
                  ...
                  o = e.providersList,
                  a = e.widget_id,
                  s = Er.shouldShowTotalShareCounter(
                    this.config.options.counter,
                    this.config.shares.total
                  ),
                  i = Er.shouldShowIndividualShareCounter(
                    this.config.options.counter,
                    this.config.shares.total
                  );
                (o = this.modifyProvidersListForSubsetWidget(o, r)),
                  n instanceof Array &&
                    n.forEach(function (e) {
                      for (
                        var n = e.querySelector("#s9-share-inline") || e,
                          c = Pr.generateUniqueId(),
                          p = 0;
                        p < o.length;
                        p++
                      ) {
                        ...
                        if (n.children && n.children.length > 0) {
                          ...
                          for (var h in n.children) {
                            ...
                            if (
                              f &&
                              f.className &&
                              f.className.startsWith(
                                "s9-btn-share s9-".concat(u)
                              )
                            ) {
                              d = !0;
                              break;
                        ...
                        l.unique_id = c;
                        var b = new Bn(l).html();
                        n.innerHTML += "".concat(b);
                      }
                      if (s) {
                        var v = new gr({
                          widget_type: r,
                          show_counter: !0,
                          share_count: t.config.shares.total,
                          widget_id: a,
                        }).html();
                        n.innerHTML += "".concat(v);
                      }
                      t.default_buttons ||
                        n.querySelectorAll("a").forEach(function (e) {
                          new nr({
                            buttons: t.config.design.buttons,
                            button: e,
                            widget_type: r,
                            show_counter: i,
                          }).applyTheme();
                        ...
                        new pr({
                          ...
                          widget_type: r,
                          element: n,
                          design: t.config.design,
                        }).applyTheme(),
                        t.addShareEventToButtons(n, a);
                    });
              },
            },
            {
              key: "createPopupWidget",
              value: function () {
                var t = this,
                  e = kr.createElement("div");
                (e.id = "s9-Modal"),
                  document.getElementById("s9-Modal") ||
                    document.body.appendChild(e),
                  "" === document.getElementById("s9-Modal").innerHTML &&
                    Yn().then(function (n) {
                      var r = n.data.providers.map(function (t) {
                          if ("social9" !== t.provider)
                            return {
                              name: t.provider,
                              intent: t.intents[0],
                              widget_type: "full",
                      ...
                      (a += r
                        ...
                        (e.innerHTML = a),
                        t.addShareEventToButtons(e, t.config.id);
                      var s = document.getElementById("s9-Modal");
            ...
            {
              key: "addShareEventToButtons",
              value: function (t, e) {
                var n = this,
                  r = (this.config.options.show_url, t.querySelectorAll("a")),
                  o = kr
                ...
                var a = kr
                    ...
                    .replace(/\r?\n|\r/g, ""),
                  s = kr.getMetaContent("property", "og:image");
                r.forEach(function (t) {
                  if ("close" !== t.getAttribute("role")) {
                    var r = kr.getAttributeValue("data-provider", t),
                      i = kr.getAttributeValue("data-href", t);
                    switch (r) {
                      case "Print":
                        kr.addEvent("click", t, function () {
                          var t = document.getElementById("s9-Modal");
                          ...
                          (i = n.customShareUrlExists
                            ...
                            (i = window.location.href =
                              "mailto:''?subject="
                                .concat(o, "&body=")
                                .concat(i)),
                            console.log("Opening email", i);
                        });
                        break;
                      default:
                        kr.addEvent("click", t, function () {
                          i = n.customShareUrlExists ? i : window.location.href;
                          var t = Pr.buildUrl(
                            "".concat(Rn, "/share/").concat(r),
                            {
                              url: i,
                              key: "",
                              title: o,
                          ...
                          kr.openWindow(t, "", { height: 500, width: 600 }),
                            (n.config.shares[r.toLowerCase()] += 1),
                            (n.config.shares.total += 1);
                          var c = document.getElementById(
                            "s9-total-share-count-".concat(n.config.id)
                          );
                          setTimeout(function () {
                            c && (c.innerHTML = n.config.shares.total);
                          }, 3e3);
                        });
                    }
                  } else
            ...
            { key: "submitFormData", value: function (t) {} },
            {
              key: "modifyProvidersListForSubsetWidget",
              value: function () {
                var t = this,
                  e =
                    arguments.length > 0 && void 0 !== arguments[0]
                  ...
                  r = Er.shouldShowIndividualShareCounter(
                    this.config.options.counter,
                    this.config.shares.total
                  );
                return e.map(function (e) {
                  return (
                    (e.default_buttons = t.default_buttons),
                    (e.widget_type = n),
                    (e.share_url = e.share_url || window.location.href),
                    (e.show_counter = r),
                    (e.share_count = t.getShareCountForIndividualProvider(
                      e.name
                    )),
                    e
                  );
            ...
            {
              key: "checkIfSocial9ProviderExists",
              value: function () {
                var t =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ? arguments[0]
                ...
                return t.some(function (t) {
                  return "social9" === t.name;
                });
              },
            },
            {
              key: "getShareCountForIndividualProvider",
              value: function (t) {
                return void 0 !== this.config.shares[t]
                  ? this.config.shares[t]
                  : 0;
              },
            },
            {
    ...
    var Lr,
      ...
      Ir = (function () {
        function t(e) {
          ...
          !(function (t, e) {
            ...
            (this.config = {
              widgets: a.data,
              hideFloat: s.hideFloat,
              hidePopup: s.hidePopup,
              hideInline: s.hideInline,
            });
        }
        var e, n, r;
        return (
          ...
          (n = [
            {
              ...
              value: function () {
                ...
                e
                  .filter(function (t) {
                    return !(
                      (o && "floating" === t.widget_type) ||
                      (r && "inline" === t.widget_type) ||
                      (a && "popup" === t.widget_type)
                    );
                  })
                  .forEach(function (e) {
                    var n = e.options.show_url;
                    if (!n || Br.shouldShowWidget(n)) {
                      var r = new Cr(e);
                      (t.containers = t.containers.concat(r.render() || [])),
                        s.push(e.id);
                    }
                  }),
                  this.trackViewForWidgetIds(s);
              },
            },
            {
              key: "clean",
            ...
            {
              key: "trackViewForWidgetIds",
              value: function (t) {
                t.length > 0 &&
                  Un({ url: Fn, method: "post", data: { ids: t } }).catch();
              },
            },
          ]) && Tr(e.prototype, n),
          r && Tr(e, r),
      ...
      Ar = function () {
        Lr && "function" == typeof Lr.clean && Lr.clean();
        var t = Vr.getAttribute("content"),
          e = "true" === Vr.getAttribute("data-hide-float"),
          n = "true" === Vr.getAttribute("data-hide-inline"),
          r = "true" === Vr.getAttribute("data-hide-popup");
        Un({
          url: "".concat(Wn, "/widgets/"),
          method: "GET",
          queryParams: { user_id: t, active: !0, url: window.location.href },
        })
          .then(function (t) {
            t &&
              t.data &&
    ...
    (history.pushState =
      ...
      function () {
        var t = qr.apply(this, arguments);
        return window.dispatchEvent(new Event("pushstate")), Ar(), t;
      })),
      (history.replaceState = (function (t) {
        return function () {
          var e = t.apply(this, arguments);
          return window.dispatchEvent(new Event("replacestate")), Ar(), e;
        };
